...
import com.example.das_primeraevaluacion.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    /**
     * Inicializa el login, listeners, campos de entrada y la nav. a login/registro
    ...
    /**
     * Hace el auth mediante el php, procesa el JSON y guarda el email en sharedPreferences
     *
     * @param email String
